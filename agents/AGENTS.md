...
Build/infra runbook lives in `agents/FACTORY.md`; charter in the root
`MISSION.md`. This folder is plaintext and public — it was git-crypt
encrypted until 2026-07-28; see the root `CLAUDE.md` for why that was
dropped.
