...
- Passive C99 network monitor for Linux; single binary, 31 ncurses views
  (incl. dashboard + Twins), warning-clean build, ~2688 test assertions
  green, smoke test 40/40 JSONL record types end-to-end.
